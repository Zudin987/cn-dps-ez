...
import {
  buildMechanicView,
  resolveWastelandCourtVoiceCues,
  S4_WASTELAND_COURT_VOICE_CUES,
} from "./mechanics";

export const s4WastelandCourtScene: SceneDefinition = {
  id: "s4-wasteland-court",
  season: 4,
  sceneIds: [6615],
  voiceCues: S4_WASTELAND_COURT_VOICE_CUES,
  resolveVoiceCues: resolveWastelandCourtVoiceCues,
