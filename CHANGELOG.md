...
- 新增 Buff 覆盖率：实时监控可配置监听列表，实时 overlay 展示自身覆盖率，历史记录汇总全队覆盖情况
  ...
  ![实时 Overlay Buff 覆盖率](./doc/shared/img/changelog/v0.2.3_1.png)

  ![历史记录 Buff 覆盖时间轴](./doc/shared/img/changelog/v0.2.3_2.png)

  ![历史记录 Buff 覆盖率汇总](./doc/shared/img/changelog/v0.2.3_3.png)
...
- 增加荒芜之庭副本机制
  ...
  ![荒芜之庭-虚痕对对碰](./doc/shared/img/changelog/v0.2.3_4.png)

  ![荒芜之庭-能量球追踪](./doc/shared/img/changelog/v0.2.3_5.png)
